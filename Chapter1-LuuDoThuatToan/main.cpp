...
// Bài 76: Kiểm tra số nguyên 4 byte có dạ3ng 3^k hay không
...
int main()
{
    ...
    //     get_num(n, 'n');
    //     get_num(x, 'x');
    // } while (check_input(x, n));

    get_num(n, 'n');
    /** 51-60
     * 
    printf("\nBiggest number: %d", biggestNum(n));
    printf("\nCount biggest number: %d", count_biggestNum(n));
    printf("\n------------------------------------------------");
    printf("\nSmallest number: %d", smallestNum(n));
    printf("\nCount smallest number: %d", count_smallestNum(n));
    printf("\n------------------------------------------------");
    printf("\nIs all ODD number: %d", check_allOddNum(n));
    printf("\nIs all EVEN number: %d", check_allEvenNum(n));
    printf("\n------------------------------------------------");
    printf("\nReverse number: %d", reverseNum(n));
    printf("\nIs reverse number: %d", check_reverseNum(n));
    printf("\n------------------------------------------------");
    printf("\nIs increase left to right: %d", check_increaseLeftToRight(n));
    */
    printf("\nFirst number: %d", firstNum(n));
    printf("\nCount first number: %d", count_firstNum(n));
    printf("\n------------------------------------------------");


    printf("\n=======TEST AGAIN? (0-NO) (1-YES)====== ");
    scanf("%d", &isMore);

    return isMore ? main() : 0;
}